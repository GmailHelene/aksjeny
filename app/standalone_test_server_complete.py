...
def stripe_success():
    """Simulated Stripe success redirect endpoint"""
    return jsonify({
        'status': 'OK',
        'message': 'Betaling vellykket! (test mode)',
...
def stripe_cancel():
    """Simulated Stripe cancel redirect endpoint"""
    return jsonify({
        'status': 'OK',
        'message': 'Betaling avbrutt! (test mode)',
...
def stripe_webhook():
    ...
    return jsonify({
        'status': 'OK',
        'message': f'Webhook mottatt: {event_type}',
